...
<div class="content-wrapper">
    ...
    <div class="col-md-12">
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
          Single move Job Post creation failed.
    ...
    <div class="col-md-12">
        <div class="alert alert-success alert-dismissible fade show" role="alert">
          Single move Job Post created successfully.
          <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <i class="fa fa-times" aria-hidden="true"></i>
          </button>
        </div>
    ...
    <div class="page-header">
        <div class="row align-items-end">
            <div class="col-lg-10">
                ...
                <div class="d-inline">
                        <h3 class=" rv-list-users">Single Move Job Post</h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-2">
        ...
        <div class="col-md-12">
            <div class="card p-3 m-3-rv">
                <div class="card-header">
                    <a href="{{url('job-post-sm/create')}}" class="btn btn-primary">Add +</a>
                   </div>
                <div class="card-body">
                        ...
                        <tbody class="mk_tbodynowrap">
                            @foreach($post_jobs as $post_job)
                                <tr>
                                    ...
                                    <td><a href="/km_admin/job-post-sm/view-sm-post/{{$post_job->booking_id}}"><button type="button" class="btn btn-success">View</button></a></td>
                                </tr>
                            @endforeach
