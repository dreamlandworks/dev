    ...
    <div class="container-fluid container_rv">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="heading">
                ...
                <h4>Create Module List</h4>
            </div>

            <form class="forms-sample" method="POST" action="{{ route('create-module-list') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="list_of_module">List of Module<span class="text-red">*</span></label>
                                <input id="list_of_module" type="text" class="form-control @error('package_name') is-invalid @enderror" name="list_of_module" value="">
