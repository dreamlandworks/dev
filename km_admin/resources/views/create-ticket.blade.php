    ...
    <div class="container-fluid container_rv">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="sp-div" id="sp-div">
                <form class="forms-sample" method="POST" action="{{ route('create-ticket') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row ">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <select name="assign_person" id="assign_person" class="form-control @error('assign_person') is-invalid @enderror">
                                    ...
                                    <option value="{{$person->id}}">{{$person->name}} -- {{$person->designations}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="created_by" id="created_by" class="form-control @error('created_by') is-invalid @enderror" value="{{$username->fname}} @if(isset($username->lname)) {{$username->lname}} @endif" readonly>
                                <div class="help-block with-errors" ></div>
                                @error('created_by')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
