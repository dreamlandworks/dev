    ...
    <div class="col-lg-12 col-md-12 col-sm-12 mk_container">
       ...
       <div class="row">
        ...
        <div class="sp-div" id="sp-div" style="display:none">
            <form class="forms-sample" method="POST" action="{{ route('create-job') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-sm-3">
            <div class="form-group">
                {{-- <input id="latt" class="form-control" type="text" placeholder="Lattitude" aria-label="Search" name="lat"> --}}
        ...
        <div class="col-sm-3">
            <div class="form-group">
                {{-- <input id="long" class="form-control" type="text" placeholder="Longitude" aria-label="Search" name="long"> --}}
        ...
        <div class="col-sm-3">
            <div class="form-group">
                {{-- <input id="long" class="form-control" type="text" placeholder="State" aria-label="Search" name="long"> --}}
        ...
        <div class="col-sm-3">
            <div class="form-group">
                <label for="city">City<span class="text-red">*</span></label>
                    ...
                    <input id="searchInput" class="controls" type="text" placeholder="Enter full location" style="height:30px;width:300px;text-align:center;margin-top:10px;">
    ...
    <script>
     function sInfo()
     {
        ...
        fd.append("u_id",$("#user_approved_id").val());
         ...
         fd.append("language",$("#tag_lang").val());
         ...
         $.ajax({
                 ...
                 success:function(data){
                    ...
                    if(data=="success") 
                    {
                        window.location=window.location.origin+"/km_admin/job-post-sm/qd/wsx";   
                    }
                    else
                    {
                        window.location=window.location.origin+"/km_admin/job-post-sm/qd/qaz";    
                    }
