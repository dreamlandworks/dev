              ...
              <div class="container-fluid container_rv">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="heading">
                        ...
                        <h4>Create Designation and Pay Details</h4>
                    </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label for="department">Department<span class="text-red">*</span></label>
                                            <input id="department" type="text" class="form-control @error('department') is-invalid @enderror" name="department" value="">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label for="pay">Pay<span class="text-red">*</span></label>
                                            <input id="pay" type="text" class="form-control @error('pay') is-invalid @enderror" name="pay" value="">
                                            <div class="help-block with-errors" ></div>
                                            @error('pay')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label for="no_of_leave">No.Of Leave<span class="text-red">*</span></label>
                                            <input id="no_of_leave" type="text" class="form-control @error('no_of_leave') is-invalid @enderror" name="no_of_leave" value="">
                                            <div class="help-block with-errors" ></div>
                                            @error('no_of_leave')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
