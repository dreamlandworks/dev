    ...
    <div class="container-fluid container_rv">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="heading">
                ...
                <h4>Create Market Statistics</h4>
            </div>
@include('includes.message')
            <form class="forms-sample" method="POST" action="{{ route('create-market-statistics') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="name_of_campaign">Name of Campaign<span class="text-red">*</span></label>
                                <input id="name_of_campaign" type="text" class="form-control @error('name_of_campaign') is-invalid @enderror" name="name_of_campaign" value="">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="ends_in">Ends In<span class="text-red">*</span></label>
                                <input id="ends_in" type="text" class="form-control @error('ends_in') is-invalid @enderror" name="ends_in" value="">
                                <div class="help-block with-errors" ></div>
                                @error('ends_in')
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="leads_generated">Leads Generated<span class="text-red">*</span></label>
                                <input id="leads_generated" type="text" class="form-control @error('leads_generated') is-invalid @enderror" name="leads_generated" value="">
                                <div class="help-block with-errors" ></div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="leads_converted">Leads Converted<span class="text-red">*</span></label>
                                <input id="leads_converted" type="text" class="form-control @error('leads_converted') is-invalid @enderror" name="leads_converted" value="">
                                <div class="help-block with-errors" ></div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="projected_budget">Projected Budget<span class="text-red">*</span></label>
                                <input id="projected_budget" type="text" class="form-control @error('projected_budget') is-invalid @enderror" name="projected_budget" value="">
                                <div class="help-block with-errors" ></div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="expenditure_till_date">Expenditure Till Date<span class="text-red">*</span></label>
                                <input id="expenditure_till_date" type="date" class="form-control @error('expenditure_till_date') is-invalid @enderror" name="expenditure_till_date" value="">
                                <div class="help-block with-errors" ></div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('cac') is-invalid @enderror" id="cac" name="cac">
                            <div class="help-block with-errors" ></div>
                            @error('cac')
