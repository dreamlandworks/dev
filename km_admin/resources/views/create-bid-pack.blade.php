    ...
    <div class="container-fluid container_rv">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="heading">
                ...
                <h4>Create Bid Packs</h4>
            </div>     
            <hr/> @include('includes.message')
            <div class="sp-div" id="sp-div">
                <form class="forms-sample" method="POST" action="{{ route('create-bid') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row ">
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="package_name" id="package_name" class="form-control @error('package_name') is-invalid @enderror">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="bids" id="bids" class="form-control @error('bids') is-invalid @enderror">
                                <div class="help-block with-errors" ></div>
                                @error('bids')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
