                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="bids_per_month">Bids Per Month<span class="text-red">*</span></label>
                                <input id="bids_per_month" type="text" class="form-control @error('bids_per_month') is-invalid @enderror" name="bids_per_month" value="">
                                <div class="help-block with-errors" ></div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="platform_fee_per_booking">Platform Fee Per Booking<span class="text-red">*</span></label>
                                <input id="platform_fee_per_booking" type="text" class="form-control @error('platform_fee_per_booking') is-invalid @enderror" name="platform_fee_per_booking" value="">
                                <div class="help-block with-errors" ></div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="sealed_bids_per_month">Sealed Bids Per Month<span class="text-red">*</span></label>
                                <input id="sealed_bids_per_month" type="text" class="form-control @error('sealed_bids_per_month') is-invalid @enderror" name="sealed_bids_per_month" value="">
                                <div class="help-block with-errors" ></div>
