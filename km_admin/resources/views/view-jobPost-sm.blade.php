    ...
    <div class="page-header">
        <div class="row align-items-end">
            <div class="col-lg-10">
                ...
                <div class="d-inline">
                        <h3 class=" rv-list-users">Single Move Job Post View</h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-2">
        ...
        <div class="col-md-12">
            <div class="card p-3 m-3-rv">
                <div class="card-header">
                    <a href="{{url('job-post-sm')}}" class="btn btn-primary">Back</a>
                   </div>
                <div class="card-body">
                        ...
                        <tbody class="mk_tbodynowrap">
                            ...
                            @foreach($each_bid_det as $post_job_bid)
                                <tr>
                                    ...
                                    <td>
                                        <a href="/km_admin/job-post-sm/view-sm-post/award/{{$post_job['id']}}"><button type="button" class="btn btn-success">Award</button></a>
                                        <a href="/km_admin/job-post-sm/view-sm-post/reject/{{$post_job['id']}}"><button type="button" class="btn btn-danger">Reject</button></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
