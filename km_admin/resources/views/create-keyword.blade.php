    ...
    <div class="container-fluid container_rv">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="heading">
                ...
                <h4>Create Skill/Keywords</h4>
            </div>

            <form class="forms-sample" method="POST" action="{{ route('create-keyword') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <label for="keyword">Keyword<span class="text-red">*</span></label>
                            <input id="keyword" type="text" class="form-control @error('keyword') is-invalid @enderror" name="keyword" value="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group-append">
                                ...
                                <span class="input-group-text" id="inputGroupPrepend">
                                    <a href="{{url('prof/create')}}"><span class="text-red">+</span></a>
                                </span>
                            </div>
                                <div class="help-block with-errors" ></div>
                                @error('profession')
