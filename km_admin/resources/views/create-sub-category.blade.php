...
<div class="content-wrapper">
    ...
    <div class="container-fluid container_rv">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <form class="forms-sample" method="POST" action="{{ route('create-sub-category') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <label for="sub_name">Sub Name<span class="text-red">*</span></label>
                            <input id="sub_name" type="text" class="form-control @error('sub_name') is-invalid @enderror" name="sub_name" value="">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="checkbox" class="custom-control-input" id="customSwitches" name="status" value="on">
