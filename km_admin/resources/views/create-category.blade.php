...
<div class="content-wrapper">
    ...
    <div class="container-fluid container_rv">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <form class="forms-sample" method="POST" action="{{ route('create-category') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="category">Category<span class="text-red">*</span></label>
                                <input id="category" type="text" class="form-control @error('category') is-invalid @enderror" name="category" value="">
