...
<div class="content-wrapper">
    <div class="container-fluid container_rv">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <form class="forms-sample" method="POST" action="{{ url('qual/update') }}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="qualification">Qualification<span class="text-red">*</span></label>
                                <input id="qualification" type="text" class="form-control @error('qualification') is-invalid @enderror" name="qualification" value="{{$qualification->qualification}}">
