    ...
    <div class="page-header">
        <div class="row align-items-end">
            <div class="col-lg-10">
                ...
                <div class="d-inline">
                        <h3 class=" rv-list-users">Payments</h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-2">
    ...
    <div>
        ...
        <div class="col-md-12">
            <div class="card p-3 m-3-rv">
                ...
                <form class="forms-sample" method="POST" action="{{ route('view-payment') }}">
                @csrf
                  <div class=row>
                    <div class="col-sm-3">
                        ...
                        <tbody id="table_data"> 
                          @foreach($transaction_array as $value)
                            <tr>
                              ...
                              <td><button data-href="{{ url('account/payment-info',[$value['id']]) }}" class="txn_info btn btn-green">View</button></td>
                            </tr>
                          @endforeach
                        </tbody>
                    </table>
...
<script type="text/javascript">
  function filter_txn()
  {
    ...
    $.ajax({
      type:'GET',
      url:'/km_admin/account/payments/'+from_date+'/'+to_date+'',
