...
<div class="content-wrapper">
    ...
    <div class="container-fluid container_rv">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <form class="forms-sample" method="POST" action="{{ route('create-lead') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="fname">First Name<span class="text-red">*</span></label>
                                <input id="fname" type="text" class="form-control @error('fname') is-invalid @enderror" name="fname" value="">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="lname">Last Name<span class="text-red">*</span></label>
                                <input id="lname" type="text" class="form-control @error('lname') is-invalid @enderror" name="lname" value="">
                                <div class="help-block with-errors" ></div>
                                @error('lname')
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="city">City<span class="text-red">*</span></label>
                                <input id="city" type="text" class="form-control @error('city') is-invalid @enderror" name="city" value="">
                                <div class="help-block with-errors" ></div>
                                @error('city')
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="help-block with-errors" ></div>
                            @error('gender')
                                <span class="invalid-gender" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            @enderror
                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="help-block with-errors" ></div>
                            @error('age_group')
                                <span class="invalid-age_group" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            @enderror
                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="occupation">Occupation<span class="text-red">*</span></label>
                                <input id="occupation" type="text" class="form-control @error('occupation') is-invalid @enderror" name="occupation" value="">
                                <div class="help-block with-errors" ></div>
                                @error('occupation')
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('hobbies') is-invalid @enderror" id="hobbies" name="hobbies" placeholder="Add Hobbies.....">
                            <div class="help-block with-errors" ></div>
                            @error('hobbies')
