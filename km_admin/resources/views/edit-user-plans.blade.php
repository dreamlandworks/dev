    ...
    <div class="container-fluid container_rv">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="heading">
                ...
                <h4>Edit User Plans</h4>
            </div>

            <form class="forms-sample" method="POST" action="{{ url('user-plan/update') }}" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{$user_plans->id}}">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="name">Name<span class="text-red">*</span></label>
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{$user_plans->name}}">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="amount">Amount<span class="text-red">*</span></label>
                                <input id="amount" type="text" class="form-control @error('amount') is-invalid @enderror" name="amount" value="{{$user_plans->amount}}">
                                <div class="help-block with-errors" ></div>
                                @error('amount')
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="period">Period<span class="text-red">*</span></label>
                                <input id="period" type="text" class="form-control @error('period') is-invalid @enderror" name="period" value="{{$user_plans->period}}">
                                <div class="help-block with-errors" ></div>
                                @error('period')
                        ...
                        <div class="form-group">
                            <label for="premium_tag">Premium Tag<span class="text-red">*</span></label>
                                <select class="form-control" id="exampleSelect" name="premium_tag">
                                    <option value="Yes" {{$user_plans->premium_tag == 'Yes' ? 'selected':''}}>Yes</option>
                                    <option value="No" {{$user_plans->premium_tag == 'Yes' ? 'selected':''}}>No</option>
                                </select>  
                                <div class="help-block with-errors" ></div>
                                @error('premium_tag')
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="posts_per_month">Posts Per Month<span class="text-red">*</span></label>
                                <input id="posts_per_month" type="text" class="form-control @error('posts_per_month') is-invalid @enderror" name="posts_per_month" value="{{$user_plans->posts_per_month}}">
                                <div class="help-block with-errors" ></div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="proposals_per_post">Proposals Per Post<span class="text-red">*</span></label>
                                <input id="proposals_per_post" type="text" class="form-control @error('proposals_per_post') is-invalid @enderror" name="proposals_per_post" value="{{$user_plans->proposals_per_post}}">
                                <div class="help-block with-errors" ></div>
                        ...
                        <div class="form-group">
                            <label for="customer_support">Customer Support<span class="text-red">*</span></label>
                                <select class="form-control" id="exampleSelect" name="customer_support">
                                    <option value="Yes"{{$user_plans->customer_support == 'Yes' ? 'selected':''}}>Yes</option>
                                    <option value="No" {{$user_plans->customer_support == 'No' ? 'selected':''}}>No</option>
                                </select>  
                                <div class="help-block with-errors" ></div>
                    ...
                    <div class="col-sm-8">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="3" name="desc">{{$user_plans->description}}</textarea>
                                <div class="help-block with-errors" ></div>
                                @error('desc')
