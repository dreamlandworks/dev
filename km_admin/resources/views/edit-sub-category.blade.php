...
<div class="content-wrapper">
    <div class="container-fluid container_rv">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <form class="forms-sample" method="POST" action="{{ url('sub-category/update') }}" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{$subcategories->id}}">
                <div class="row">   
                <div class="col-sm-4">
                    <div class="form-group">
                        <label for="sub_name">Sub Name<span class="text-red">*</span></label>
                            <input id="sub_name" type="text" class="form-control @error('sub_name') is-invalid @enderror" name="sub_name" value="{{$subcategories->sub_name}}">
                            <div class="help-block with-errors" ></div>
                            @error('sub_name')
                                <span class="invalid-sub_name" role="alert">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="exampleSelect" name="category">
                                ...
                                <option value="{{$category->id}}" {{$subcategories->category_id == $category->id ? 'selected' : ''}}>{{$category->category}}</option>
                                @endforeach
                            </select> 
                                <div class="help-block with-errors" ></div>
                                @error('category')
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="checkbox" class="custom-control-input" id="customSwitches" name="status" value="on" {{$subcategories->status == 'Active' ? 'checked':'Inactive'}}>
