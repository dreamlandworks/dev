    ...
    <div class="container-fluid container_rv">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="sp-div" id="sp-div" style="display:none">
                        <form class="forms-sample" method="POST" action="{{ route('create-sp') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group-append">
                                            <select class="form-control" id="exampleSelect" name="profession">
                                                ...
                                                <option value="{{$sp_profession->id}}">{{$sp_profession->name}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="input-group-append">
                                            <select class="form-control" id="exampleSelect" name="qualification">
                                                @foreach($sp_quali as $sp_qua)
                                                    <option value="{{$sp_qua->id}}">{{$sp_qua->qualification}}</option>
                                                @endforeach
                                            </select>
                                            <span class="input-group-text" id="inputGroupPrepend">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="exampleSelect" name="sp_exp">
                                            @foreach($sp_exps as $sp_exp)
                                                <option value="{{$sp_exp->id}}">{{$sp_exp->exp}}</option>
                                            @endforeach
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="about_us">About Us<span class="text-red">*</span></label>
                                            <input id="about_us" type="text" class="form-control @error('about_us') is-invalid @enderror" name="about_us" value="">
                                            <div class="help-block with-errors" ></div>
                                            @error('about_us')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group-prepend">
                                            ...
                                            <input id="per_hour" type="text" class="form-control @error('per_hour') is-invalid @enderror" name="per_hour" value="">
                                        </div>
                                            <div class="help-block with-errors" ></div>
                                            @error('per_hour')
                                                <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group-prepend">
                                            ...
                                            <input id="per_day" type="text" class="form-control @error('per_day') is-invalid @enderror" name="per_day" value="">
                                        </div>
                                            <div class="help-block with-errors" ></div>
                                            @error('per_day')
                                                <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group-prepend">
                                            ...
                                            <input id="min_charge" type="text" class="form-control @error('min_charge') is-invalid @enderror" name="min_charge" value="">
                                        </div>
                                            <div class="help-block with-errors" ></div>
                                            @error('min_charge')
                                                <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group-prepend">
                                            ...
                                            <input id="extra_charge" type="text" class="form-control @error('extra_charge') is-invalid @enderror" name="extra_charge" value="">
                                        </div>
                                            <div class="help-block with-errors" ></div>
                                            @error('extra_charge')
                                                <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select id="km-select" class="form-control" name="availability" aria-label="Default select example" onchange = "day()">
                                        <option>Choose Your Availability Day</option>
                                        <option value="everyDay">Every Day</option>
                                        <option value="weakDay">Week Day</option>
                                        <option value="weakDay">Week End</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                ...
                                <div id="allDay" class="col-sm-3" style="display: none;">
                                    <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body mx-3">
        ...
        <div class="md-form mb-2">
            <select class="form-control" id="subcategory" name="sub_name" onchange="sub_cat()">
        ...
        <div class="md-form mb-5">
            <div class="form-group d-none" id="category1">
...
<script>
    function sub_cat()
    {
        console.log('khushi');
        $('#category').empty();
      var data_fetch =  $("#subcategory").val();
      if(data_fetch != ""){
        $.ajax({
                type: "GET",
                url: "{{url('sp/sub/scategory')}}",
    ...
    <script>
        function getUser()
        {
            ...
            success:function(data){
                ...
                if((data)=="Already_sp")
                {
                    $('#mobile_search').html('<span style="color:red">This user is already service provider ! Try again.</span>');
                    $('#fname').html('');
                    $('#lname').html('');
                    $('#mobile').html('');
                    $('#sp-div').attr('style','display:none');
