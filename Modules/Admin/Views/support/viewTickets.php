                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body ">
                                        <form class="form-horizontal">
                                          <div class="row">
                                            <label class="col-md-2 col-form-label">Complaint ID : </label>
                                            <div class="col-md-9">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-md-9">
                                              <div class="form-group">
                                                <input type="text" class="form-control" disabled value="service Provider">
                                              </div>
                                            </div>
                                          </div>
                                          <div class="row">
                                            ...
                                            <div class="col-md-9">
                                              <div class="form-group">
                                                <input type="text" class="form-control" disabled value="Resolved">
                                              </div>
                                            </div>
                                          </div>
