            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="#pablo">Create New Ticket</a>
                    </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card ">
                                    ...
                                    <div class="card-body ">
                                        ...
                                        <form enctype="multipart/form-data" method="POST" id="addCompliants" role="form" action="<?php echo ADMINBASEURL; ?>edit_ticket_submit">
                                        <input type="hidden" class="form-control" name="compliant_id" id="compliant" value="<?php echo $compliant->id; ?>">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-5 col-md-6 col-sm-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control datepicker" value="<?php echo date('Y-m-d',strtotime($compliant->created_on)) ?>" name="created_on"
                                                            id="created_on" >
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="exampleDesignation"
                                                            class="bmd-label-floating">Booking Id</label>
                                                        ...
                                                        title="Select Booking" data-size="7" id="booking" name="booking">
                                                         ...
                                                         ?>
                                                         <option value="<?php echo $booking['id'];?>" <?=($compliant->bookingId==$booking['id'])?'selected':''; ?>><?php echo $booking_ref_id = str_pad($booking['id'], 6, "0", STR_PAD_LEFT);?></option>
                                                         <?php }?>
                                                         </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="textarea" class="form-control" id="description" name="description" value="<?php echo $compliant->description;?>">
                                                    </div>
                                                ...
                                                <div class="col-lg-5 col-md-6 col-sm-12" style="margin:0.4rem 2rem">
                                                    ...
                                                    <?php foreach($arr_compliant_module as $key => $module) {
                                                         ...
                                                         ?>
                                                         <option value="<?php echo $module['id'];?>" <?=($compliant->module_id==$module['id'])?'selected':''; ?>><?php echo $module['module_name'];?></option>
                                                         <?php }?>
                                                </select>
                                                    <div class="form-group">
                                                        ...
                                                        <option value="Urgent" <?=($compliant->priority== 'Urgent')?'selected':''; ?>>Urgent </option>
                                                        <option value="High priority" <?=($compliant->priority== 'High priority')?'selected':''; ?>>High priority</option>
                                                        <option value="Medium Priority" <?=($compliant->priority== 'Medium Priority')?'selected':''; ?>>Medium Priority</option>
                                                        <option value="Low priority" <?=($compliant->priority== 'Low priority')?'selected':''; ?>>Low priority</option>
                                                    </select>
                                                    </div>
                                                    <div class="form-group">
                                                       ...
                                                       <?php foreach($arr_staffs as $key => $staffs) {
                                                         ...
                                                         ?>
                                                         <option value="<?php echo $staffs['staff_id'];?>" <?=($compliant->assigned_to==$staffs['staff_id'])?'selected':''; ?>><?php echo $staffs['staff_name'];?></option>
                                                         <?php }?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <option value="In Progress" <?=($compliant->status=='In Progress')?'selected':''; ?>>In Progress </option>
                                                        <option value="Resolved" <?=($compliant->status=='Resolved')?'selected':''; ?>>Resolved</option>
                                                        <option value="Not Assigned"<?=($compliant->status=='Not Assigned')?'selected':''; ?>>Not Assigned </option>
                                                        <option value="Pending" <?=($compliant->status=='Pending')?'selected':''; ?>>Pending</option>
                                                        <option value="In Review" <?=($compliant->status=='In Review')?'selected':''; ?>>In Review</option>
                                                        <option value="Transferred" <?=($compliant->status=='Transferred')?'selected':''; ?>>Transferred</option>
                                                        <option value="Re Open" <?=($compliant->status=='Re Open')?'selected':''; ?>>Re Open</option>
                                                    </select>
                                                    </div>
                                                </div>
                                            </div>
	...
	var addCompliantsForm = $("#addCompliants");	
    	var validator = addCompliantsForm.validate({		
    		...
    		messages:{
    		    ...
    		    booking : {required : "Select booking"},
