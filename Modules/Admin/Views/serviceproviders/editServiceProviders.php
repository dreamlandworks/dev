            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="#pablo">Edit Service Provider</a>
                    </div>
                                        ...
                                        <form method="#" action="#">
                                            <div class="row">
                                                <div class="col-lg-5 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <label for="exampleName" class="bmd-label-floating">
                                                            First Name </label>
                                                        <input type="text" class="form-control" id="name" value="John">
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="exampleName" class="bmd-label-floating">Last Name
                                                        </label>
                                                        <input type="text" class="form-control" id="name" value="Danenil">
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="exampleDesignation"
                                                            class="bmd-label-floating">Mobile</label>
                                                        <input type="text" class="form-control" id="designation" value="9885112928">
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="examplePass" class="bmd-label-floating">Email
                                                            <span style="color:red">*</span></label>
                                                        <input type="email" class="form-control" id="examplePass" value="john@gmail.com">
                                                    </div>
                                                ...
                                                <div class="col-lg-5 col-md-6 col-sm-12" style="margin:0.4rem 2rem">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="exampleName" class="bmd-label-floating">City
                                                        </label>
                                                        <input type="text" class="form-control" id="name" value="cityname">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleName" class="bmd-label-floating">State
                                                        </label>
                                                        <input type="text" class="form-control" id="name" value="statename">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleName" class="bmd-label-floating">Country
                                                        </label>
                                                        <input type="text" class="form-control" id="name" value="countryname">
                                                    </div>
