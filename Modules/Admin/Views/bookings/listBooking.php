                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                ...
                                <div class="card card-stats">
                                    <div class="card-header card-header-warning card-header-icon">
                                        ...
                                        <h3 class="card-title">Pending - <?php echo $arr_bookingStatusCount[0]['booking_count']; ?></h3>
                                    </div>
                                    <div class="card-footer">
                                        <div class="stats">
                                            Pending - <?php echo $arr_bookingStatusCount[0]['booking_count']; ?> 
                                        </div>
                                    </div>
                                </div>
                                </a>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                ...
                                <div class="card card-stats">
                                    <div class="card-header card-header-rose card-header-icon">
                                        ...
                                        <h3 class="card-title">In Progress - <?php echo $arr_bookingStatusCount[1]['booking_count']; ?></h3>
                                    </div>
                                    <div class="card-footer">
                                        <div class="stats">
                                            In Progress - <?php echo $arr_bookingStatusCount[1]['booking_count']; ?>
                                        </div>
                                    </div>
                                </div>
                                </a>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                ...
                                <div class="card card-stats">
                                    <div class="card-header card-header-success card-header-icon">
                                        ...
                                        <h3 class="card-title">Completed - <?php echo $arr_bookingStatusCount[2]['booking_count']; ?></h3>
                                    </div>
                                    <div class="card-footer">
                                        <div class="stats">
                                            Competed - <?php echo $arr_bookingStatusCount[2]['booking_count']; ?>
                                        </div>
                                    </div>
                                </div>
                                </a>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="material-datatables">
                                            <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                                ...
                                                <tbody>
													<?php
													  if($arr_bookings != 'failure') {
														  foreach($arr_bookings as $key => $listBookings) {
													  ?>
                                                    <tr>
                                                        <td class="text-center"><?php echo ($key+1); ?></td>
                                                        <td><?php echo $listBookings['booking_id']; ?></td>
                                                        <td>Rs.<?php echo $listBookings['amount']; ?></td>
                                                        <td><?php echo $listBookings['scheduled_date']; ?></td>
                                                        <td><?php echo $listBookings['booking_time']; ?></td>
                                                        <td><?php 
																if($listBookings['reschedule_status_id'] == 1){
																	echo "Yes";
																} else{
																	echo "No";
																}
															?></td>
                                                        <td><?php 
														$scheduled_date = $listBookings['scheduled_date'] . " " . $listBookings['booking_time'];
														...
														echo $remaining_days." days ".$remaining_hours." hours ".$remaining_minutes. " minutes "; 
														
														?></td>
                                                        <td><?php echo $listBookings['category']; ?></td>
                                                        <td><?php echo $listBookings['booking_status']; ?></td>
                                                        <td>
                                                        ...
                                                        <td class="td-actions">
															<!--<a href="#">-->
																   <a href="<?php echo 'listBookingView/'.$listBookings['booking_id'];?>">
                                                                <h4><b>View</b></h4>
                                                            </a>
															<button type="button" rel="tooltip" data-id="<?php echo $listBookings['booking_id']; ?>" class="btn btn-danger btn-round btndelete">
																<i class="material-icons">
