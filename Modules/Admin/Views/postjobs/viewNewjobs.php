            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="#pablo"> List Jobs</a>
                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body ">
                                        <form class="form-horizontal">
                                          <div class="row">
                                            <label class="col-md-2 col-form-label">Post ID : </label>
                                            <div class="col-md-9">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-md-9">
                                              <div class="form-group">
                                                <input type="text" class="form-control" disabled value="5000">
                                              </div>
                                            </div>
                                          </div>
                                          <div class="row">
                                            ...
                                            <div class="col-md-9">
                                              <div class="form-group">
                                                <input type="text" class="form-control" disabled value="Premium">
                                              </div>
                                            </div>
                                          </div>
                                          <div class="row">
                                            <label class="col-md-2 col-form-label">Bids Period : </label>
                                            <div class="col-md-9">
                                              <div class="form-group">
                                                <input type="text" class="form-control" disabled value="2 months">
                                              </div>
                                            </div>
                                          </div>
                                          <div class="row">
                                            <label class="col-md-2 col-form-label">Days to Expire : </label>
                                            <div class="col-md-9">
                                              <div class="form-group">
                                                <input type="text" class="form-control" disabled value="20 days">
                                              </div>
                                            </div>
                                          </div>
                                          <div class="row">
                                            <label class="col-md-2 col-form-label">Bookings Id : </label>
                                            <div class="col-md-9">
                                              <div class="form-group">
                                                <input type="text" class="form-control" disabled value="3528664">
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-md-9">
                                              <div class="form-group">
                                                <input type="text" class="form-control" disabled value="Singe Move">
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-md-9">
                                              <div class="form-group">
                                                <input type="text" class="form-control" disabled value="Expired">
                                              </div>
                                            </div>
                                          </div>
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-md-9">
                                              <div class="form-group">
                                                <input type="text" class="form-control" disabled value="Reject">
                                              </div>
                                            </div>
                                          </div>
                                        </form>
