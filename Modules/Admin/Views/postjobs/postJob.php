            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="#pablo">Create Bookings</a>
                    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card ">
                                <div class="card-header card-header-rose card-header-icon">
                                    ...
                                    <h4 class="card-title">Single Move Form</h4>
                                </div>
                                <div class="card-body ">
                                    <form method="#" action="#">
                                        <div class="row">
                                            <div class="col-lg-5 col-md-6 col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    <label for="Publishing_year">Date Time <span
                                                            style="color:red">*</span></label>
                                                    <input type="datetime-local" class="form-control datepicker"
                                                        value="" id="exampleJoining_date">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleName" class="bmd-label-floating">Description
                                                    </label>
                                                ...
                                                <select class="selectpicker" data-style="select-with-transition"
                                                    ...
                                                    <option value="2">Subcat 1 </option>
                                                    <option value="3">subcat 2 </option>
                                                </select>


                                                <select class="selectpicker" data-style="select-with-transition"
                                                    title="Select Bid" data-size="7">
                                                ...
                                                <select class="selectpicker" data-style="select-with-transition"
                                                    title="Select Bid Range" data-size="7">
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleDesignation" class="bmd-label-floating">Estimated
                                                        Time In Days</label>
                                                ...
                                                <select class="selectpicker" data-style="select-with-transition"
                                                    title="Accept Bids Duration" data-size="7">
                                                ...
                                                <div class="form-group">
                                                    <label for="examplePass" class="bmd-label-floating">
                                                        Languages Preferred <span style="color:red">*</span></label>
                                                ...
                                                <div class="form-group">
                                                    <label for="examplePass" class="bmd-label-floating"> Keywords/
                                                        Skills needed
                                                    </label>
