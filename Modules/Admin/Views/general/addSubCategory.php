            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="#pablo">Create New Sub-Category</a>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card ">
                                    ...
                                    <div class="card-body ">
                                       <form enctype="multipart/form-data" method="POST" id="categoryDetails" role="form" action="<?php echo ADMINBASEURL; ?>create_subcategory_submit">
                                           <div class="row">
                                                <div class="col-lg-5 col-md-6 col-sm-12">
                                                    

                                                    <div class="form-group">
                                                        <label for="exampleName" class="bmd-label-floating">Sub Category Name
                                                        </label>
