                        ...
                        <div class="modal fade modal-mini modal-primary" id="myModal11" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-small">
                               ...
                               font-size: x-large;">Add Profession</h4>
                                    ...
                                    <option value="2">SubCategory 1 </option>
                                    <option value="3">SubCategory  2 </option>
                                    <option value="4">SubCategory 3 </option>
                                    <option value="5">SubCategory 4 </option>
                                    <option value="6">SubCategory 5 </option>
                                    <option value="7">SubCategory 6 </option>
                                </select>
                                    </div>
                                    <div class="modal-footer justify-content-center">


                                        <button type="button" class="btn btn-fill btn-teal"
