                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card ">
                                    ...
                                    <div class="card-body ">
                                        <form enctype="multipart/form-data" method="POST" id="categoryDetails" role="form" action="<?php echo ADMINBASEURL; ?>create_category_submit">
                                            <div class="row">
	...
	var categoryDetailsForm = $("#categoryDetails");	
    	var validator = categoryDetailsForm.validate({		
    		...
    		messages:{
    		    ...
    		    category_image : {extension : "Only Image file"}
