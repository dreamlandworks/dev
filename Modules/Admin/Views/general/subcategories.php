                          ...
                          <div class="card-body">
                            ...
                            <div class="material-datatables">
                              <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0"
                                ...
                                <tbody>
                                 <?php   
                                    if($arr_subcategories != 'failure') {
                                    foreach($arr_subcategories as $key => $subcategories){ ?>
                                  <tr>
                                    <td class="text-center"><?php echo ($key+1); ?></td>
                                    <td><?php echo $subcategories['category']; ?> </td>
                                    <td><?php echo $subcategories['sub_name']; ?> </td>
                                    <td><img src="<?php echo base_url().$subcategories['image']; ?> " height="30px"/></td>
                                    <td>
                                      <div class="togglebutton">
                                        <label>
                                          <input class ="chkstatus" data-id="<?php echo $subcategories['id']; ?>"  type="checkbox" <?php echo ($subcategories['status'] == 'Active') ? 'checked' : ''; ?> >
                                          <span class="toggle"></span>
                                        </label>
                                      </div>
                                    </td>
                                    <td class="td-actions">
                                      <a href="<?php echo 'editSubCategory/'.$subcategories['id'];?>">
                                      ...
                                      <button data-id="<?php echo $subcategories['id']; ?>" type="button" rel="tooltip" class="btn btn-danger btn-round btndelete">
                                        <i class="material-icons">
  ...
  <script>
   ...
   $('.chkstatus').on('change', function() {
     ...
     if(this.checked)
      ...
      $.ajax({
            type: "POST",
            url: '<?php echo "editSubcategoryStatus";?>',
   ...
   $('.btndelete').on('click', function() {
      ...
      $.ajax({
            type: "POST",
            url: '<?php echo "deleteSubCategory";?>',
