            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="#pablo">Add New Keywords</a>
                    </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card ">
                                    <div class="card-header card-header-rose card-header-icon">
                                        ...
                                        <h4 class="card-title">New Keyword</h4>
                                        ...
                                        <form method="#" action="#">
                                            <div class="row">
                                                <div class="col-lg-5 col-md-6 col-sm-12">
                                                    <select class="selectpicker" multiple data-style="select-with-transition"
                                                    title="Select Profession" data-size="7">
                                                    <option value="2">Profession1 </option>
                                                    <option value="3">profession 2 </option>
                                                    <option value="4">Profession3 </option>
                                                    <option value="5">Profession4 </option>
                                                    <option value="6">Profession5 </option>
                                                    <option value="7">Profession6 </option>
                                                </select>

                                                <select class="selectpicker" multiple data-style="select-with-transition"
                                                title="Select Keywords" data-size="7">
                                                <option value="2">Keyword 1 </option>
                                                <option value="3">Keyword 2 </option>
                                                <option value="4">Keyword 3 </option>
                                                <option value="5">Keyword 4 </option>
                                                <option value="6">Keyword 5 </option>
                                                <option value="7">Keyword 6 </option>
                                            </select>
